...
function otherrealm_scripts() {
	...
	wp_enqueue_script('tinymce', get_template_directory_uri() . '/js/tinymce/js/tinymce/tinymce.min.js', array('jquery'), '20200205', true);
	wp_enqueue_script('tinymcejquery', get_template_directory_uri() . '/js/tinymce/js/tinymce/jquery.tinymce.min.js', array('jquery'), '20200205', true);
